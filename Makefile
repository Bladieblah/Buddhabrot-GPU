...
CFLAGS = -g -O3 $(WARNFLAGS) -MD -Iinclude/ -I./ -Iimgui/ -Iimplot/ -Iimgui/backends/ -I/usr/local/include -I/opt/homebrew/Cellar/glfw/3.4/include
LDFLAGS =-framework opencl -framework OpenGL -L/opt/homebrew/Cellar/glfw/3.4/lib -lglfw
